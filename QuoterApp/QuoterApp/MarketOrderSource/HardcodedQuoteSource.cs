...
namespace QuoterApp.MarketOrderSource
{
    public class HardcodedMarketOrderSource : IMarketOrderSource
    {
        ...
        public event EventHandler<MarketOrderEventArgs> MarketOrderReceived;
        ...
        public MarketOrder GetNextMarketOrder()
        {
            ...
            var nextOrder = _quotes[position++];

            OnMarketOrderReceived(nextOrder);

            return nextOrder;
        }

        protected virtual void OnMarketOrderReceived(MarketOrder marketOrder)
        {
            MarketOrderReceived?.Invoke(this, new MarketOrderEventArgs(marketOrder));
        }
    }
}
